...
import com.unicorn.simpletracker.R;
...
public class menu extends Fragment {
     ...
     * @return A new instance of fragment view_menu.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        m_NewEvent =(Button) v.findViewById(R.id.new_event_button);
...
//                Toast.makeText(MainActivity.this, "Create new event", Toast.LENGTH_SHORT).show();
        ...
        m_ViewEvent = (Button) v.findViewById(R.id.view_event_button);
